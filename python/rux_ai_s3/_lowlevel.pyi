...
from rux_ai_s3.types import EnvFullOut
...
class ParallelEnv:
    ...
    def seq_step(self, actions: npt.NDArray[np.int64]) -> EnvFullOut: ...
    def par_step(self, actions: npt.NDArray[np.int64]) -> EnvFullOut: ...
